 ...
 */
 ...
 [_GAMING] = LAYOUT(
  ...
  KC_GRV,  KC_Z,  KC_X , KC_C,    KC_D,     KC_V,    COLEMAK,              COLEMAK,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,  KC_EQL,
                         KC_LALT, KC_LCTRL, KC_LSFT, KC_SPC,               LT_RSRT,  KC_LPRN, KC_RPRN, KC_CAPS
),
